...
%     end
    ...
    if ismember(iData,[1,2])
        ...
        for iTest=1:2
            if       iTest==1; thisPair=[1,2]; % rest hv vs hpo
            elseif   iTest==2; thisPair=[3,4]; % test hv vs hpo
            end
...
save([destDir '/' 'EEG_Spectra_STATS_Control.mat'],'Alpha_Stats','Alpha_Stats_BLC');% taken ssv stats out'SSV_Stats'
