%==========================================================================
% PURPOSE: do a RM ANOVA with 1 var
...
% edit observedData matrix if necessary
%observedData = observedData(:,1:4); %for alpha control analysis, just do fixation data

% make a directory for histogram plots
...
save([dataFile '_STATS.mat'],'var1','observedData','nullDataMat');